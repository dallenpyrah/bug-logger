<template>
  <div class="container-fluid bg-light">
    <div class="row mt-homepage">
      <div class="col-6 mt-4 text-left ml-5">
        <h1 class="mt-3 text-danger animate__animated animate__fadeInLeft text-big">
          BUG LOGGER
        </h1>
        ...
        <div class="row mt-5 ml-5">
          ...
          <div class="col-9">
            <h4 class="mt-bug hover ml-3 text-grey hover animate__animated animate__shakeY animate__repeat-3 animate__delay-2s" @click="routeToBugPage">
              Bugs page
            </h4>
          </div>
        </div>
